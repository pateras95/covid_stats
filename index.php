...
<body>
  <main>
    <header>
      <div>
        <svg width="446" height="403" viewBox="0 0 446 403">
          <title>virus</title>
  ...
  <script>
    $(document).ready(function() {
      ...
      //Timeline to change the scale of the virus outer parts
      ...
      //Timeline to change the position of the outer parts of the virus
